...
function FloatingButtons() {
  return (
    <div className="floating-buttons">
      <a href="tel:+919680333942" className="float-btn call-btn" aria-label="Call Us">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.8.6 2.7a2 2 0 0 1-.5 2.1L8 9.7a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2.1-.5c.9.3 1.8.5 2.7.6a2 2 0 0 1 1.7 2.1Z"/></svg>
      </a>
      <a href="https://wa.me/919680333942?text=Hi%2C%20I%20am%20interested%20in%20your%20marble%20products.%20Please%20share%20more%20details." target="_blank" rel="noopener noreferrer" className="float-btn wa-btn" aria-label="WhatsApp">
